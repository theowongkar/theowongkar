...
<p>
  Hello, I am Theoterra Pitray Wongkar, a professional with expertise in web development, network engineering, digital marketing management, and creative content creation. I also run a biotechnology-based aquaculture business. The combination of technical skills and an entrepreneurial spirit makes me adaptable, collaborative, and always ready to face challenges across industries.
</p>

<h2>💼 Work Experience</h2>

<h3 style="margin: 10px 0px 5px 0px; font-size: 15px;">🧑‍💻 Freelance Full Stack Web Developer</h3>
<ul style="line-height: 1.5;">
    <li>Web-based child abuse reporting system for the North Sulawesi Women's Empowerment and Child Protection Service.</li>
    <li>Web-based regional business promotion platform for the North Sulawesi Regional Tourism Promotion Agency.</li>
    <li>Web-based employee attendance management system for the North Sulawesi Regional Police.</li>
    <li>Web-based church information system for GMAHK Kamanga.</li>
</ul>

<h3 style="margin: 10px 0px 5px 0px; font-size: 15px;">🐟 Wusa Garden Nila Bioflok (Aquaculture Business)</h3>
<ul style="line-height: 1.5;">
    <li>Founded and managed a biofloc-based fish farming business.</li>
    <li>Applied biotechnology to improve cultivation efficiency.</li>
    <li>Handled financial, operational, and marketing aspects of the business.</li>
</ul>

<h3 style="margin: 10px 0px 5px 0px; font-size: 15px;">🏭 Intern - PT. Meares Soputan Mining</h3>
<ul style="line-height: 1.5;">
    <li>Assisted in administrative tasks within the HRD department.</li>
    <li>Sorted job applicant data and edited safety induction videos.</li>
    <li>Developed a cooperative sales recap application using VBA (Visual Basic for Applications) in Microsoft Excel.</li>
</ul>

<h3 style="margin: 10px 0px 5px 0px; font-size: 15px;">📱 Digital Marketing Manager (UKM Kewirausahaan)</h3>
<ul style="line-height: 1.5;">
    <li>Provided digital marketing services through social media platforms.   </li>
    <li>Edited visual content including photos, videos, and graphic designs for promotional use.</li>
</ul>
...
<ul style="line-height: 1.5;">
    ...
    <li>Performed installation and maintenance of fiber optic networks.</li>
</ul>
...
<ul>
    <li><b>Language:</b> Indonesian (Fluent), English (Basic).</li>
...
<p>
Website Badan Pusat Statistik (BPS), North Sulawesi. Specifically designed for meeting minutes recording system.
</p>

<h3 style="margin: 10px 0px 5px 0px; font-size: 15px;">5. Elapor DP3A Sulut</h3>
<p>
Website Dinas Pemberdayaan Perempuan dan Perlindungan Anak (DP3A), North Sulawesi. Designed as an information system for reporting violence against children.
</p>
...
<h3 style="margin: 10px 0px 5px 0px; font-size: 15px;">1. 3RD Floor Cafe & Resto</h3>
<p>
...
<h3 style="margin: 10px 0px 5px 0px; font-size: 15px;">2. Baby JCD Ice Cream</h3>
<p>
...
<h3 style="margin: 10px 0px 5px 0px; font-size: 15px;">3. PKM Mapalus Siaga</h3>
<p>
...
<p>
Website creation services (Landing Page, Company Profile/UMKM, School/Organization Website, Online Store, Government/Institution Website)
</p>
...
<h2>🐟 Wusa Garden Nila Bioflok (Aquaculture Business):</h2>
